...
with col1:
    st.markdown(f'''
        <a href=" " target="_blank" style="text-decoration: none;">
            <button class="custom-upgrade-btn base-btn">🚀 升级基础版 ($9.99/月)</button>
        </a >
    ''', unsafe_allow_html=True)

with col2:
    st.markdown(f'''
        <a href="你的高级版支付链接" target="_blank" style="text-decoration: none;">
            <button class="custom-upgrade-btn premium-btn">⭐ 升级高级版 ($14.99/月)</button>
        </a >
    ''', unsafe_allow_html=True)
