...
BRAIN_POLICIES: Final[dict[str, BrainPolicy]] = {
    ...
    "general": BrainPolicy(
        policy_name="general",
        preferred_model="DeepSeek",
        fallback_models=("Qwen", "GLM-4", "Doubao-Pro"),
        use_capability_ranking=True,
        allowed_models=("DeepSeek", "Qwen", "GLM-4", "Doubao-Pro"),
        prefer_chinese_models=True,
        max_tokens=1100,
        temperature=0.45,
